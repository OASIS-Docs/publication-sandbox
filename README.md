...
| CSAF v2.0 csd01 | 1 true finding: a `TODO: add the link.` that really shipped in 2021 |
...
Three GitHub Actions wrap seven commands. Nothing else in the YAML affects the
